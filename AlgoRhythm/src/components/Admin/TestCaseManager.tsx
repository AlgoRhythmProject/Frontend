...
import { Plus, Trash2, Edit2, Eye, EyeOff, Save, X, Clock } from 'lucide-react';
...
export function TestCaseManager({ testCases, onChange, disabled = false }: TestCaseManagerProps) {
    ...
    const handleAdd = () => {
        const newTestCase: TestCaseInputData & { id: string } = {
            ...
            timeoutMs: formData.timeoutMs, // Już są milisekundy
        };
    ...
    const startEdit = (testCase: TestCase | (TestCaseInputData & { id: string })) => {
        ...
        setFormData({
            ...
            timeoutMs: testCase.timeoutMs, // Już są milisekundy
        });
                                ...
                                <div>
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            {testCase.timeoutMs != null && (
                                                <span className="px-2 py-0.5 bg-warning/20 text-warning rounded-full text-xs font-sans font-medium flex items-center gap-1">
                                                    <Clock className="w-3 h-3" />
